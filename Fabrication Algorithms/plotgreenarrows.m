function plotgreenarrows(geuler,eulerpath,pos,linesize,arrowsize,viewangle)
...
%figure()
trussplot = plot(digeuler, 'XData', pos(:,1), 'YData', pos(:,2), 'Zdata', pos(:,3), 'LineWidth',linesize, 'ArrowSize', arrowsize, 'NodeLabel', {}, 'NodeColor', [0 0.4470 0.7410]);
...
highlight(trussplot,'Edges',1:numedges(digeuler),'EdgeColor',[0 0.5 0])
set(gcf,'color','w');
axis equal
axis off
view(viewangle)
