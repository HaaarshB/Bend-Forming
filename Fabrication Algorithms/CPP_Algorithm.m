function [geulerian,dupedges,edgesadded,lengthadded,epath] = CPP_Algorithm(g,pos)
...
% Follows this website: https://freakonometrics.hypotheses.org/53694
    ...
    if sum(mod(degree(g),2))<=2 % two or less nodes with odd degree
        ...
        epath = Hierholzer(geulerian);
    else % more than two nodes with odd degree
        [geulerian,dupedges,edgesadded,lengthadded] = MakeEulerian(g,pos); % make truss Eulerian then run Hierholzer algorithm
