function [geulerian,dupedges,edgesadded,lengthadded,epath] = CPP_Algorithm_Fluery_Greedy_CM_Compact(g,pos)
...
% Follows this website: https://freakonometrics.hypotheses.org/53694
    ...
    if sum(mod(degree(g),2))<=2 % two or less nodes with odd degree
        ...
        epath = Fluery_Greedy_CM_Compact(geulerian,pos);
