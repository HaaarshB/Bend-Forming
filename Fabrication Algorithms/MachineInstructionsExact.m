function MachineInstructionsExact(path,pos,filename,commentbool)
%% Function for converting an Euler path through a desired truss into EXACT machine instructions for a CNC wire bender with 3 DOFs (feed, bend, and rotate)
