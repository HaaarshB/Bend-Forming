...
def assembly_and_pinBC():
    ...
    mdb.models['Model-1'].StaticRiksStep(name='AlignmentRiks', previous='Initial', 
        nlgeom=ON, maxLPF=1.0, maxNumInc=1000, initialArcInc=1e-05)
...
def apply_BCdisplacements(filename):
    ...
    with open(filename) as file:
        for line_num, line in enumerate(file,1):
            ...
            mdb.models['Model-1'].DisplacementBC(name=BCname, createStepName='AlignmentRiks', 
...
def setup_and_run_job():
    mdb.Job(name='TrussAlignDispRiks', model='Model-1', description='', type=ANALYSIS, 
        ...
        numGPUs=0)
    mdb.jobs['TrussAlignDispRiks'].submit(consistencyChecking=OFF)
...
assembly_and_pinBC()
# apply_MPCconstraints("C:\\Users\\harsh\\Documents\\GitHub\\Bend-Forming\\Accuracy Model\\AbaqusFiles\\Code\\FixedDisplacements\\MPCconstraints.txt") % no MPC constraints with Riks Relax?
...
setup_and_run_job()
mdb.saveAs(pathName="C:\Users\harsh\Documents\GitHub\Bend-Forming\Accuracy Model\AbaqusFiles\TrussAlignDispRiks") # save CAE file for future reference
#extract_RFforces("C:\\Users\\harsh\\Documents\\GitHub\\Bend-Forming\\Accuracy Model\\AbaqusFiles\\TrussAlignDispRiks.odb", "C:\\Users\\harsh\\Documents\\GitHub\\Bend-Forming\\Accuracy Model\\AbaqusFiles\\Code\\FixedDisplacements\\RFatNodes.txt")
#extract_selfstress("C:\\Users\\harsh\\Documents\\GitHub\\Bend-Forming\\Accuracy Model\\AbaqusFiles\\TrussAlignDispRiks.odb", "C:\\Users\\harsh\\Documents\\GitHub\\Bend-Forming\\Accuracy Model\\AbaqusFiles\\Code\\FixedDisplacements\\MaxMisesStress.txt")